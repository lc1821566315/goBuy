                                        ...
                                        <div class="order-progress">
                                            <ul>
                                                <li class="first active">
                                                    ...
                                                    <div class="info">{{orderinfo.confirm_time | cut}}</div>
                                                </li>
                                                <li class="">
                                                    <div class="progress">已付款</div>
                                                    <div class="info">{{orderinfo.payment_time | cut}}</div>
                                                </li>
                                                <li class="">
                                                    <div class="progress">已经发货</div>
                                                    <div class="info">{{orderinfo.express_time | cut}}</div>
                                                </li>
                                                <li class="last">
                                                    <div class="progress">已完成</div>
                                                    <div class="info">{{orderinfo.complete_time | cut}}</div>
                                                </li>
                                            </ul>
                                        </div>
...
import axios from 'axios';
    ...
    created(){
        ...
        axios.get(`http://47.106.148.205:8899/site/validate/order/getorderdetial/${this.orderId}`)
        .then(response=>{
